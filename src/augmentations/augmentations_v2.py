...
def transform(args):
    ...
    transform = Compose([
        ...
        RandRotate([args.rotate_min, args.rotate_max], padding=mean, ignore_label=False),
        RandomGaussianBlur(),
        RandomHorizontalFlip(),
        Crop([args.train_h, args.train_w], crop_type='rand', padding=mean, ignore_label=False),
        ToTensor(),
